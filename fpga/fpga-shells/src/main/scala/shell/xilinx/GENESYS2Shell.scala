...
/*
package sifive.fpgashells.shell.xilinx.genesys2shell
...
import sifive.fpgashells.ip.xilinx.{IBUFDS, PowerOnResetFPGAOnly, sdio_spi_bridge, genesys2_sys_clock_mmcm0,
                                    genesys2_sys_clock_mmcm1, genesys2reset}

//-------------------------------------------------------------------------
// GENESYS2Shell
//-------------------------------------------------------------------------

trait HasDDR3 { this: GENESYS2Shell =>
  
  require(!p.lift(MemoryXilinxDDRKey).isEmpty)
  val ddr = IO(new XilinxGENESYS2MIGPads(p(MemoryXilinxDDRKey)))
  
  def connectMIG(dut: HasMemoryXilinxGENESYS2MIGModuleImp): Unit = {
    // Clock & Reset
    dut.xilinxgenesys2mig.sys_clk_i := sys_clock.asUInt
    mig_clock                    := dut.xilinxgenesys2mig.ui_clk
    mig_sys_reset                := dut.xilinxgenesys2mig.ui_clk_sync_rst
    dut.xilinxgenesys2mig.aresetn   := mig_resetn
    dut.xilinxgenesys2mig.sys_rst   := sys_reset

    ddr <> dut.xilinxgenesys2mig
  }
}

abstract class GENESYS2Shell(implicit val p: Parameters) extends RawModule {
  ...
  //25MHz and multiples
  val genesys2_sys_clock_mmcm0 = Module(new genesys2_sys_clock_mmcm0)
  genesys2_sys_clock_mmcm0.io.clk_in1 := sys_clock.asUInt
  genesys2_sys_clock_mmcm0.io.reset   := reset
  val clk12_5              = genesys2_sys_clock_mmcm0.io.clk_out1
  val clk25                = genesys2_sys_clock_mmcm0.io.clk_out2
  val clk37_5              = genesys2_sys_clock_mmcm0.io.clk_out3
  val clk50                = genesys2_sys_clock_mmcm0.io.clk_out4
  val clk100               = genesys2_sys_clock_mmcm0.io.clk_out5
  val clk150               = genesys2_sys_clock_mmcm0.io.clk_out6
  val clk75                = genesys2_sys_clock_mmcm0.io.clk_out7
  val genesys2_sys_clock_mmcm0_locked = genesys2_sys_clock_mmcm0.io.locked

  //65MHz and multiples
  val genesys2_sys_clock_mmcm1 = Module(new genesys2_sys_clock_mmcm1)
  genesys2_sys_clock_mmcm1.io.clk_in1 := sys_clock.asUInt
  genesys2_sys_clock_mmcm1.io.reset   := reset
  val clk32_5              = genesys2_sys_clock_mmcm1.io.clk_out1
  val clk65                = genesys2_sys_clock_mmcm1.io.clk_out2
  val genesys2_sys_clock_mmcm1_locked = genesys2_sys_clock_mmcm1.io.locked
  ...
  do_reset             := !mig_mmcm_locked || !mmcm_lock_pcie || mig_sys_reset || !genesys2_sys_clock_mmcm0_locked ||
                          !genesys2_sys_clock_mmcm1_locked
  ...
  val safe_reset = Module(new genesys2reset)
